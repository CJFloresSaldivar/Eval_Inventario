export function generarPaginaIndex(usuario,rol) {
    ...
    switch(rol){
            ...
            CardSection = `
                <!-- Earnings (Monthly) Card Example -->
                                        <div class="col-xl-3 col-md-6 mb-4">
                                            <a id="centrada" onclick='window.generatePage("productos","${usuario}","${rol}")' href="#" class="text-decoration-none">
                                        ...
                                        <!-- Tasks Card Example -->
                                        <div class="col-xl-3 col-md-6 mb-4">
                                            <a id="cjournal" onclick='window.generatePage("journal","${usuario}","${rol}")' href="#" class="text-decoration-none">
                                            <div class="card border-left-info shadow h-100 py-2">
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Histórico
                                                            </div>
                                                            <div class="row no-gutters align-items-center">
                                                                <div class="col-auto">
        ...
        case '2':
            ...
            CardSection = `
                                                    ...
                                                    <div class="col-xl-3 col-md-6 mb-4">
                                                        <a id="csalida" onclick='window.generatePage("productos","${usuario}","${rol}")' href="#" class="text-decoration-none">
                                                        <div class="card border-left-success shadow h-100 py-2">
                                                            <div class="card-body">
                                                                <div class="row no-gutters align-items-center">
                                                                    <div class="col mr-2">
                                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                                            Salida productos</div>
                                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"> </div>
                                                                    </div>
                                                                    <div class="col-auto">
